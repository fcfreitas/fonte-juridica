...
export interface RepetitivosSearchParams {
...
export interface RepetitivosResult {
...
// Compartilhado entre a rota /api/repetitivos e o carregamento inicial (SSR)
// da página de listagem, para não duplicar a lógica de filtros/ordenação/paginação.
export async function queryRepetitivos(params: RepetitivosSearchParams): Promise<RepetitivosResult> {
  ...
  // contrato ao serem passados como props (ex.: RepetitivosPageClient),
